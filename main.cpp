...
static void visualize(int x = -1, int y = -1, int z = -1) {
...
static void inplaceHeapSort(int* input, int n){
...
static int partition_array(int a[], int si, int ei){
...
static void merge2SortedArrays(int a[], int si, int ei)
{
...
static void randomizeAndSaveArray(){
